...
export declare const zh: {
    ...
    teamRoster: string;
    teamOpenMember: string;
    teamTasks: string;
    teamCreate: string;
    teamNoTasks: string;
    teamReady: string;
    teamBlocked: string;
    teamBlockedBy: string;
    teamWriteScopes: string;
    teamOwner: string;
    teamUnowned: string;
    teamEdit: string;
    teamComplete: string;
    ...
    memberRunning: string;
    memberIdle: string;
    memberInactive: string;
    memberProvisioning: string;
    memberFailed: string;
    openPlugin: string;
    copyInstall: string;
    ...
    trajectory: string;
    trajEmpty: string;
    trajUnavailable: string;
    trajUnavailableHint: string;
    trajFollow: string;
    trajFit: string;
    trajZoomIn: string;
    trajZoomOut: string;
    ...
    trajStop: string;
    trajSpeed: string;
    trajStatsNodes: string;
    trajStatsEdges: string;
    trajStatsTurns: string;
    trajStatsTokens: string;
    trajTurn: string;
    trajCollapsed: string;
    trajInspectorHint: string;
    trajSeq: string;
    trajDuration: string;
    trajUsage: string;
    trajLaneInput: string;
    trajLaneModel: string;
    trajLaneTool: string;
    ...
    gitBehind: string;
    gitPushed: string;
    gitPendingPush: string;
    gitNoUpstream: string;
    gitPush: string;
    gitPushing: string;
    gitCommitPush: string;
    gitCommitPushFailed: string;
    gitPushFailed: string;
    gitUntracked: string;
    gitBranchSearch: string;
    gitBranchNoMatch: string;
    gitBranchNew: string;
    gitBranchNamePlaceholder: string;
    gitBranchCreate: string;
    gitBranchCreateFailed: string;
    gitBranchCurrent: string;
    gitBranchRemote: string;
    gitBranchTracked: string;
    gitBranchDelete: string;
    gitBranchDeleteDesc: string;
    gitBranchDeleteForce: string;
    gitBranchDeleteUnmerged: string;
    gitBranchDeleteFailed: string;
    ghSection: string;
    ghEnv: string;
    ghNotInstalled: string;
    ...
    ghOpen: string;
    ghMerge: string;
    ghMergeConfirm: string;
    ghMerged: string;
    ghMergeFailed: string;
    ghDraft: string;
    ghCreatePr: string;
    ghCreateIssue: string;
    ghCreatedPr: string;
    ghCreatedIssue: string;
    ghCreatePrFailed: string;
    ghCreateIssueFailed: string;
    ghPrTitle: string;
    ghIssueTitle: string;
    ghBody: string;
    ghCreate: string;
