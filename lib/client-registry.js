	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			awaitingAnswerLabel: "等待你的回答（在下方输入框回复）",
			sideChatNew: "新建对话",
		...
		const en = {
			...
			awaitingAnswerLabel: "Waiting for your answer — reply in the composer below",
		...
		*/
		...
		var sidebar_module_css_default = {
			...
			"sidechatCard": "S5HVoW_sidechatCard",
			"sidechatCardFail": "S5HVoW_sidechatCardFail",
			"sidechatCardOptionLabel": "S5HVoW_sidechatCardOptionLabel",
			"sidechatCardOptions": "S5HVoW_sidechatCardOptions",
			"sidechatCardPath": "S5HVoW_sidechatCardPath",
			"sidechatTurnSummary": "S5HVoW_sidechatTurnSummary",
			...
			switch (row.kind) {
				...
				case "tool": {
					...
					const body = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						card?.type === "question" && card.questions.map((question, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SideChatView_module_css_default.sidechatCard,
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: SideChatView_module_css_default.sidechatCardPath,
									children: labels.awaitingAnswerLabel
								})
							]
						}, `q:${String(index)}`)),
